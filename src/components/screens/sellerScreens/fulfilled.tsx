...
export default function SellerFulfilled(){
    async function fetchOrderItems(){
        const response = await fetchOrderItemsForSeller({status: "fulfilled"}, {})
    ...
    </Table></div>: <div className=" text-center text-gray-800 mt-96 font-bold">No fulfilled orders!</div>}
</>)
}